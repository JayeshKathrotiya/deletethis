    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form action="/update_profileAdmin" id="valid_update_profile" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                     <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="editmobile" id="editmobile" class="form-control" placeholder="Mobile No*" maxlength="10" value="{{$class->mobile}}">
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Email</label> <span class="req-star text-danger"> *</span>
                                <input type="email" name="editemail" id="editemail" class="form-control" placeholder="Email Address*" maxlength="50" value="{{$class->email}}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
                                <button class="btn btn-success" type="submit" id="btn_update">Update</button>
                                <button class="btn btn-warning mr-1" type="submit" id="btn_update">Cancel</button>
    ...
    if (type==1)
    {
      $.confirm({
            ...
            buttons: {
                Yes: function () {               
                  $.ajax({
                    url:'{{route('profile.delete_class_imageAdmin')}}',
                    method:'POST',
                    dataType:'JSON',
                    data:{id:random},
      ...
      if (extention == "jpg" || extention == "png" || extention == "jpeg") {
        if (validImage.size <= 1024000 * 2) {
            ...
            var formdata = new FormData();
              ...
              $.ajax({
                  url:'{{route('profile.updateclassImageAdmin')}}',
                  dataType:'JSON',
                  method:'post',
                  data:formdata,
                  contentType:false,
    ...
    if (type==1)
    {
      $.confirm({
            ...
            buttons: {
                Yes: function () {               
                  $.ajax({
                    url:'{{route('class.deleteTubeAdmin')}}',
                    method:'POST',
                    dataType:'JSON',
                    data:{id:random},
                    success:function(data)
    ...
    if (type==1)
    {
      $.confirm({
            ...
            buttons: {
                Yes: function () {               
                  $.ajax({
                    url:'{{route('profile.delete_ranker_imageAdmin')}}',
                    method:'POST',
                    dataType:'JSON',
                    data:{id:random},
                    success:function(data)
      ...
      if (extention == "jpg" || extention == "png" || extention == "jpeg") {
        if (validImage.size <= 1024000 * 2) {
            ...
            var formdata = new FormData();
              ...
              $.ajax({
                  url:'{{route('profile.updaterankerImageAdmin')}}',
                  dataType:'JSON',
                  method:'post',
                  data:formdata,
                  contentType:false,
    ...
    if (type==1)
    {
      ...
      $.confirm({
            ...
            buttons: {
                Yes: function () {               
                  $.ajax({
                    url:'{{route('class.deletePdfAdmin')}}',
                    method:'POST',
                    dataType:'JSON',
                    data:{id:random},
                    success:function(data)

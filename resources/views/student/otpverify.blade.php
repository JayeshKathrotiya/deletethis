...
@section('contents')
<?php $reg_data = session('student_reg_session'); ?>
<?php $student_reg_mobile_session = session('student_reg_mobile_session'); ?>
    ...
    if (!empty($reg_data)) {
       ?>
        ...
        <section class="registeration">
            <div class="container">
                <form action="/student/verifyOtp" method="POST" id="update_mobile" name="update_mobile">
                @csrf
                        ...
                        <div class="reg-form-box">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <p>+91 <?php echo $student_reg_mobile_session ? $student_reg_mobile_session : ""; ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <button onclick="javascript:resendOTP({{$student_reg_mobile_session}},{{$reg_data['inserted_id']}})" class="edit-number" id="resend_otp">Resend OTP</button>
                                    <input type="text" name="otp" id="otp" class="form-control" placeholder="OTP*" maxlength="4">
                                    <!-- <a href="javascript:resendOTP({{$student_reg_mobile_session}},{{$reg_data['inserted_id']}})" class="edit-number">Resend OTP</a> -->
        ...
        $('#update_mobile').validate({
            rules:
            {
                mobile:
                {
                    required:true,
                    remote:{
                       url:"{{route('stud.checkEditMobileExists')}}",
                       type:"POST",
                       dataType:"json",
                       data: 
                       {

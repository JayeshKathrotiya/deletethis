...
@section('contents')
    ...
    <section class="registeration">
        <div class="container">
            <form action="/student/check_login" method="POST" id="valid_login_stud" name="valid_login_stud">
            @csrf
                ...
                <div class="col-lg-6 col-md-10 col-sm-12">
                    <div class="reg-form-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                              <a href="/stud/forgot" class="text-blue">Forgot Password</a></label>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>New to OKTAT ? <a href="/student/registration" class="text-blue">
                                    Sign Up</a></label>
                                </div>
                              </div>
                            <div class="col-md-12">

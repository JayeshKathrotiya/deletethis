...
@section('contents')
    ...
    <section class="registeration">
        <div class="container">
            <form action="/class/add_registration" method="POST" id="valid_reg" name="valid_reg">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Class Name*" maxlength="50">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                      <input type="checkbox" id="cl_terms" name="cl_terms" value="1">
                                      <!-- /class-terms -->
                                      I Accept Oktat <a class="text-blue" href="javascript:openTermsMdl()">Terms and Conditions</a> , By clicking Submit, you indicate that you have read and agree to the Terms of use and <a href="javascript:openPolicyMdl()" class="text-blue">Privacy Policy.</a>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group ml-4">
                                    <div class="checkbox checkbox-primary checkbox-inline">
                                        <input type="checkbox" id="cl_terms" name="cl_terms" value="1">
                                        <label for="cl_terms">I Accept Oktat <a target="_blank" href="/class-terms">Terms and Conditions</a> , By clicking Submit, you indicate that you have read and agree to the Terms of use.</label>
                                    </div>
                                </div>
                            </div> -->
                            <div class="col-md-12">

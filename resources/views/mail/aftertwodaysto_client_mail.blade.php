<html lang="en-US">
    	...
    	<body>
            <h4>Dear {{$owner_name ? $owner_name : ""}},</h4>
            <p>This is to inform you that 2 days have passed since {{$student_name ? $student_name : ""}} took admission in your coaching class , so as per our refund and cancellation, User Name Admission is hereby irrevocably confirmed and finalized.</p>
